...
@section('content')
    <h3 class="card-title float-sm-left"><a href="{{route('gallery.create')}}" class="btn btn-success" >إضافة</a></h3>
                ...
                <th>{{$row->cat->ar_category ?? ''}}</th>
                    ...
                    <th>
                        <div class="btn-group">
                            ...
                            <a  class="btn btn-default" href="{{route('gallery.edit', $row->id) }}"><i class="fas fa-edit"
                                    title="edit"></i></button>

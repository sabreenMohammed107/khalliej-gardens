    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" style="direction:rtl">
            ...
            <div class="form-group">
                <label for="file-upload" class="custom-file-label">
                    <i class="fa fa-cloud-upload"></i>{{old('image') }}
                  </label>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 mt-4" style="direction:rtl">
            ...
            <div class="form-group">
                ...
                <input name="ar_name" value="{{old('ar_name') }}"  type="text" class="form-control" placeholder="الاسم عربى">
            </div>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 mt-4" style="direction:rtl">
            ...
            <div class="form-group">
                ...
                <input name="en_name" value="{{old('en_name') }}"  type="text" class="form-control" placeholder="الاسم انجليزى">
            </div>
        </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" style="direction:rtl">
            ...
            <div class="form-group">
                ...
                <textarea name="ar_desc"   class="form-control" placeholder="النص">{{old('ar_desc') }}</textarea>
            </div>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" style="direction:rtl">
            ...
            <div class="form-group">
                ...
                <textarea name="en_desc"   class="form-control" placeholder="النص">{{old('en_desc') }}</textarea>
            </div>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" style="direction:rtl">
        <div class="form-group ">

...
@section('content')
    <h3 class="card-title float-sm-left"><a href="{{route('service.create')}}" class="btn btn-success" >إضافة</a></h3>
                ...
                <th><img width="100" src="{{ asset('uploads/service') }}/{{ $row->image }}" /></th>
                    ...
                    <th>
                        <div class="btn-group">
                            ...
                            <a  class="btn btn-default" href="{{route('service.edit', $row->id) }}"><i class="fas fa-edit"
                                    title="edit"></i></button>

...
@section('content')
    <h3 class="card-title float-sm-left"><a href="{{route('whyus.create')}}" class="btn btn-success" >إضافة</a></h3>
                ...
                <th>{{ $index + 1 }}</th>
                    ...
                    <th>
                        <div class="btn-group">
                            ...
                            <a  class="btn btn-default" href="{{route('whyus.edit', $row->id) }}"><i class="fas fa-edit"
                                    title="edit"></i></button>

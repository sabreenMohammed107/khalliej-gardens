...
<head>
    ...
    <meta property="og:url" content="http://gulfgardens.net/" />
    ...
    <link rel="stylesheet" href="{{ asset('webassets/css/bootstrap.css') }}">
    ...
    <link rel="stylesheet" href="{{ asset('webassets/css/animate.min.css') }}">
...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-ZBKLC3DD33"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-ZBKLC3DD33');
</script>
</head>
